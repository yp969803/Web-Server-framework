    ...
    while True:
        try:
            pid, status = os.waitpid(
                ...
                os.WNOHANG    # Don not block and return EWOULDBLOCK error
            )
...
class WSGIServer(object):
    ...
    def __init__(self, server_address):
        ...
        # Bind the socket to the port (may throw an OSError)
